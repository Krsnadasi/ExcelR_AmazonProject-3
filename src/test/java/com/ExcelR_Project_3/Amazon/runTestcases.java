package com.ExcelR_Project_3.Amazon;
...
import PageObjects.amazonCategory;
import PageObjects.amazonCountry;
import PageObjects.amazonHomePage;
import PageObjects.amazonRegistration;
import PageObjects.amazonShopping;
import PageObjects.automationLanguage;
import io.github.bonigarcia.wdm.WebDriverManager;

public class runTestcases {
	public WebDriver driver;
	amazonHomePage homePG;
	amazonRegistration register;
	automationLanguage lang;
	amazonCountry country;
	amazonCategory category;
	amazonShopping shopAmz;
    amazonCart  cartAmz;
	...
	{ WebDriverManager.chromedriver().setup();
	  ...
	  homePG=new amazonHomePage(driver);
	  register=new amazonRegistration(driver);
	  lang=new automationLanguage(driver);
	  country=new amazonCountry(driver);
	  category=new amazonCategory(driver);
	  shopAmz=new amazonShopping(driver);
	  cartAmz=new amazonCart(driver);
	}
  @Test(priority=1)
  ...
  public void KannadaLanguage_Validation() {
      ...
      lang.select_KannadaLanguage();
  }
  @Test(priority=9)
  public void MarathiLanguage_Validation() {
	  homePG.launchURL();
      lang.language_Verification();
      lang.select_MarathiLanguage();
  }
  @Test(priority=10)
